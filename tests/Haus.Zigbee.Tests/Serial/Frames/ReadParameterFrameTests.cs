...
public class ReadParameterFrameTests
{
    ...
    [Fact]
    public void GivenFailureStatusResponseWithNoValueBytesWhenDecodingThenExposesStatusAndParameterIdWithEmptyValue()
    {
        byte[] frame = [0x0A, 0x44, 0x01, 0x08, 0x00, 0x01, 0x00, 0x07];
