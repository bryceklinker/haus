...
{
    public static DeviceEntity AddDevice(
        this HausDbContext context,
        string? externalId = null,
        string? name = null,
        DeviceType deviceType = DeviceType.Unknown,
        Action<DeviceEntity>? configure = null
    )
    {
    ...
    public static RoomEntity AddRoom(
        this HausDbContext context,
        string? name = null,
        Action<RoomEntity>? configure = null
    )
    {
        var room = new RoomEntity { Name = name ?? $"{Guid.NewGuid()}" };
        configure?.Invoke(room);
        context.AddAndSave(room);
        return room;
    }

    public static DiscoveryEntity AddDiscovery(
        this HausDbContext context,
    ...
    public static HealthCheckEntity AddHealthCheck(
        this HausDbContext context,
        string? name = null,
