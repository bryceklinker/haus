...
{
    public class CreateWebClientCommandHandlerTests
    {
        private readonly IConfiguration _configuration;
        private readonly ConfigurationDbContext _context;

        public CreateWebClientCommandHandlerTests()
        {
        ...
        public async Task WhenIdentityClientCreatedThenClientAllowsIdentityApiScope()
        {
            ...
            client.ClientId.Should().Be("haus.web");
            client.ClientName.Should().Be("HAUS Web");
