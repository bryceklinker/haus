...
public record OccupancyChangedModel(string DeviceId, bool Occupancy = false, long Timeout = 0,
    string Sensitivity = null) : IHausEventCreator<OccupancyChangedModel>
{
