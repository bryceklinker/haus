...
export function createAsyncActionSet<TRequestParams extends any[], TRequest extends object, TSuccessParams extends any[], TSuccess extends object, TFailedParams extends any[], TFailed extends object>(
  type: string,
